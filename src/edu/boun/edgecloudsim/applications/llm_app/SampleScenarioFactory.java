...
package edu.boun.edgecloudsim.applications.llm_app;

import edu.boun.edgecloudsim.cloud_server.CloudServerManager;
import edu.boun.edgecloudsim.cloud_server.DefaultCloudServerManager;
import edu.boun.edgecloudsim.core.ScenarioFactory;
import edu.boun.edgecloudsim.edge_client.DefaultMobileDeviceManager;
import edu.boun.edgecloudsim.edge_client.DelaySensitiveMobileDeviceManager;
...
public class SampleScenarioFactory implements ScenarioFactory {
	...
	public MobileDeviceManager getMobileDeviceManager() throws Exception {
		return new DelaySensitiveMobileDeviceManager();
	}
